...
class CustomModel(tf.keras.Model): #  with unscaled inputs
    def __init__(self, kernel_initializer, bias_initializer,
        ...
        # alpha network
        self.L1alpha.trainable     = False
        self.L2alpha.trainable     = False
        self.L3alpha.trainable     = False
        self.L4alpha.trainable     = False
        self.L5alpha.trainable     = False
        self.alpha_layer.trainable = False

        # theta network
        self.L1theta.trainable     = False
        self.L2theta.trainable     = False
        self.L3theta.trainable     = False
        self.L4theta.trainable     = False
        self.L5theta.trainable     = False
        self.theta_layer.trainable = False

        # dele network
        self.L1dele.trainable     = False
        self.L2dele.trainable     = False
        self.L3dele.trainable     = False
        self.L4dele.trainable     = False
        self.L5dele.trainable     = False
        self.dele_layer.trainable = False
